...
#include "MBR GUI Design Child Mod - Switch.au3"
#include "MBR GUI Design Child Mod - Forecast.au3"

GUISwitch($hGUI_MOD)

$hGUI_MOD_TAB = GUICtrlCreateTab(0, 0, $_GUI_MAIN_WIDTH - 20, $_GUI_MAIN_HEIGHT - 255, BitOR($TCS_MULTILINE, $TCS_RIGHTJUSTIFY))
$hGUI_MOD_TAB_ITEM1 = GUICtrlCreateTabItem(GetTranslated(600,62, "Switch Account && Profile Options"))
; this tab will be empty because it is only used to display a child GUI
$hGUI_MOD_TAB_ITEM2 = GUICtrlCreateTabItem(GetTranslated(600,63, "Forecast"))
; this tab will be empty because it is only used to display a child GUI
