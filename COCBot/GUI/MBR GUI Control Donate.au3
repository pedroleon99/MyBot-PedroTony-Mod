...
;~ 0xE4A438
   ...
   _Sleep(250)
	...
	If WaitforPixel(230, 140 , 240, 145 , Hex(0xE8ECE0, 6), 10, 10) Then
		...
		Local $ArmyCampTroop = GtfoCheckTrainingTab("troop") ; pedroleon99 Pedro&Tony MOD
...
;~ 			DonatedTroop($GtfoTroopType, $iTroopTrain)
	...
	If WaitforPixel(430, 140 , 440, 145 , Hex(0xE8ECE0, 6), 10, 10) Then
		...
		Local $ArmyCampSpell = GtfoCheckTrainingTab("spell") ; GTFO - Pedro&Tony MOD
