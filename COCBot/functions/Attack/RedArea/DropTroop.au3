...
Func DropTroop($troop, $nbSides, $number, $slotsPerEdge = 0, $indexToAttack = -1)
	...
	If ($g_abAttackStdSmartAttack[$g_iMatchMode]) And ($g_aiAttackStdDropSides[$g_iMatchMode] <> 4) Then ; FourFinger - Demen		If $slotsPerEdge = 0 Or $number < $slotsPerEdge Then $slotsPerEdge = $number
