...
Func readConfig($inputfile = $config, $partial = False) ;Reads config and sets it to the variables
	...
	If FileExists($config) Then
		...
		IniReadS($ibtnCloseWaitExact, $config, "other", "btnCloseWaitExact", 1, "int")
		IniReadS($ibtnCloseWaitRandom, $config, "other", "btnCloseWaitRandom", 0, "int")
...
#CE
		...
		$iSkipDonateNearFulLTroopsEnable = IniRead($config, "donate", "SkipDonateNearFulLTroopsEnable", 0)
		;InireadS(xxxx,$config, "attack", "xxxx", 0, "int")
