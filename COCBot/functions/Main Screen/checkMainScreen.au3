...
Func IsWaitingForConnection($LoopCount = 1, $LoopDelay = 200)
	...
	For $i = 1 To $LoopCount
		_CaptureRegion()
		If _ColorCheck(_GetPixelColor(430, 365, $g_bNoCapturePixel), Hex(0xEF7800, 6), 20) Then
			If _ColorCheck(_GetPixelColor(427, 362, $g_bNoCapturePixel), Hex(0xFF8800, 6), 20) Then
				If _ColorCheck(_GetPixelColor(432, 369, $g_bNoCapturePixel), Hex(0xB75C00, 6), 20) Then
					If _ColorCheck(_GetPixelColor(429, 365, $g_bNoCapturePixel), Hex(0xEF7800, 6), 20) Then
						If _ColorCheck(_GetPixelColor(426, 362, $g_bNoCapturePixel), Hex(0x7F4000, 6), 20) Then
							If _ColorCheck(_GetPixelColor(433, 369, $g_bNoCapturePixel), Hex(0x3F2000, 6), 20) Then
								$IsWaiting = True
							Else
								$IsWaiting = False
								ExitLoop
